...
public class Game extends Thread{
	...
	public void dropNotes() {
           ...
           //8초         
			...
			beats = new NoteBeat[] {
					new NoteBeat(startTime, "S"),
		               ...
		               new NoteBeat(startTime+gap*10, "D"),
		               new NoteBeat(startTime+gap*12, "K"),
		               new NoteBeat(startTime+gap*14, "D"),
		               new NoteBeat(startTime+gap*16, "L"),
		               new NoteBeat(startTime+gap*18, "F"),
		               new NoteBeat(startTime+gap*20, "L"),
		               new NoteBeat(startTime+gap*22, "F"),
		      ...
		      //8초         
		               ...
		               new NoteBeat(startTime+gap*1190, "F"),
		               new NoteBeat(startTime+gap*1195, "L"),
		               new NoteBeat(startTime+gap*1200, "D"),
		               new NoteBeat(startTime+gap*1205, "F"),
		               new NoteBeat(startTime+gap*1210, "L"),
		               new NoteBeat(startTime+gap*1215, "F"),
		               new NoteBeat(startTime+gap*1220, "D"),
			...
			beats = new NoteBeat[] {
					...
					new NoteBeat(startTime+gap*364,"L" ),
					new NoteBeat(startTime+gap*367,"K" ),
					new NoteBeat(startTime+gap*369,"J" ),
					new NoteBeat(startTime+gap*367,"F" ),
					new NoteBeat(startTime+gap*369,"J" ),
					new NoteBeat(startTime+gap*364,"F" ),
					new NoteBeat(startTime+gap*367,"D" ),
					new NoteBeat(startTime+gap*369,"S" ),
					...
					new NoteBeat(startTime+gap*364,"F" ),
					new NoteBeat(startTime+gap*367,"D" ),
					new NoteBeat(startTime+gap*369,"F" ),
					new NoteBeat(startTime+gap*367,"D" ),
					new NoteBeat(startTime+gap*369,"S" ),
					
					new NoteBeat(startTime+gap*364,"L" ),
					new NoteBeat(startTime+gap*367,"J" ),
					new NoteBeat(startTime+gap*369,"K" ),
					new NoteBeat(startTime+gap*367,"L" ),
					new NoteBeat(startTime+gap*369,"J" ),
					new NoteBeat(startTime+gap*364,"K" ),
					
					new NoteBeat(startTime+gap*367,"J" ),
					new NoteBeat(startTime+gap*369,"K" ),
					new NoteBeat(startTime+gap*364,"L" ),
					new NoteBeat(startTime+gap*366,"K" ),
					new NoteBeat(startTime+gap*367,"J" ),
					new NoteBeat(startTime+gap*369,"K" ),
					new NoteBeat(startTime+gap*364,"J" ),
					new NoteBeat(startTime+gap*366,"F" ),
					new NoteBeat(startTime+gap*367,"J" ),
					new NoteBeat(startTime+gap*369,"K" ),
					
					new NoteBeat(startTime+gap*366,"L" ),
					new NoteBeat(startTime+gap*367,"D" ),
					new NoteBeat(startTime+gap*369,"S" ),
					new NoteBeat(startTime+gap*367,"D" ),
					new NoteBeat(startTime+gap*369,"F" ),
					...
					new NoteBeat(startTime+gap*366,"S" ),
					new NoteBeat(startTime+gap*367,"D" ),
					new NoteBeat(startTime+gap*369,"F" ),
					new NoteBeat(startTime+gap*364,"J" ),
					new NoteBeat(startTime+gap*366,"F" ),
					...
					new NoteBeat(startTime+gap*367,"F" ),
					new NoteBeat(startTime+gap*369,"D" ),
					new NoteBeat(startTime+gap*364,"F" ),
					new NoteBeat(startTime+gap*366,"D" ),
					new NoteBeat(startTime+gap*367,"S" ),
					new NoteBeat(startTime+gap*369,"D" ),
					new NoteBeat(startTime+gap*367,"F" ),
					new NoteBeat(startTime+gap*369,"J" ),
					new NoteBeat(startTime+gap*364,"K" ),
					...
					new NoteBeat(startTime+gap*367,"J" ),
					new NoteBeat(startTime+gap*369,"L" ),
					new NoteBeat(startTime+gap*364,"K" ),
					new NoteBeat(startTime+gap*366,"L" ),
					...
					new NoteBeat(startTime+gap*364,"S" ),
					new NoteBeat(startTime+gap*366,"D" ),
					new NoteBeat(startTime+gap*367,"F" ),
					new NoteBeat(startTime+gap*369,"D" ),					
					new NoteBeat(startTime+gap*366,"F" ),
					...
					new NoteBeat(startTime+gap*369,"D" ),
					new NoteBeat(startTime+gap*364,"F" ),
					new NoteBeat(startTime+gap*366,"J" ),
					new NoteBeat(startTime+gap*367,"K" ),
					new NoteBeat(startTime+gap*369,"J" ),
					new NoteBeat(startTime+gap*364,"D" ),
					new NoteBeat(startTime+gap*366,"S" ),
					...
					new NoteBeat(startTime+gap*352,"S" ),
					new NoteBeat(startTime+gap*355,"S" ),
					new NoteBeat(startTime+gap*358,"J" ),
					new NoteBeat(startTime+gap*362,"K" ),
					...
					new NoteBeat(startTime+gap*364,"D" ),
					new NoteBeat(startTime+gap*366,"F" ),
					new NoteBeat(startTime+gap*341,"J" ),
					new NoteBeat(startTime+gap*344,"F" ),
					new NoteBeat(startTime+gap*347,"J" ),
					new NoteBeat(startTime+gap*349,"K" ),
					
					new NoteBeat(startTime+gap*352,"L" ),
					new NoteBeat(startTime+gap*355,"J" ),
					new NoteBeat(startTime+gap*358,"J" ),
					new NoteBeat(startTime+gap*362,"K" ),
		...
		public void judge (String input) { //ť ó�� ���� 
			for (int i =0; i< noteList.size(); i++) {
				Note note = noteList.get(i);
